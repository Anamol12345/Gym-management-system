...
<div class="section-tittle2 mb-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
    <div class="front-text">
        <h2 class="">group trainer</h2>
        <p>Workouts using the energy of a small group or team of people</p>  
        <p>around you and the expertise of the coach to maximize your</p>
        <p>results.</p>
                ...
                <div class="col-lg-12">
                    <div class="footer-copy-right text-center">
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="https://www.Anamogymcenter" target="_blank">Anamol Gym center</a>
