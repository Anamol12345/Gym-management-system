    ...
    <div class="gallery-area section-padding30 ">
        <div class="container-fluid ">
            <div class="row">
                ...
                <div class="row">
                <?php
require_once './user/db_connection.php';
...
if ($con) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $fullPath = 'http://localhost/gym%20management%20system/admin/dashboard/admin/' . $row["image"];

            echo '<h1 class="opacity-zero">'.$fullPath.'</h1>';
            echo '<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">';
            echo '<div class="box snake mb-30">';
            echo '<div class="gallery-img big-img" style="background-image: url(\'' . $fullPath . '\');"></div>';
            echo '<div class="overlay">';
            echo '<div class="overlay-content">';
            echo '<h1 class="text-white">'.$row["title"].'</h1>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="https://www.AnamolGymcentertarget="_blank">Anamol Gym center</a>
