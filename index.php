                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                 <span data-animation="fadeInLeft" data-delay="0.1s">Welcome to Anamol Gym center</span>             
                        ...
                        <div class="topic-img">
                            ...
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    ...
                                    <p>It develops individualized fitness programs for its clients, inspiring and engaging them. <br> guiding them to achieve their goals.</p>
                                    <a href="personal trainer.php" class="border-btn">View Offers</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-topic text-center mb-30">
                        <div class="topic-img">
                            ...
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    <h3>Group traning</h3>
                                    <p>It is the same individual who designs and implements safe and efficient workout routines for healthy individuals.<br>  groups, or those with medical clearance to exercise.</p>
                                    <a href="group training.php" class="btn">View Offers</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s" >
                        ...
                        <div class="cat-cap">
                            ...
                            <p>Victory isn't defined by wins and losses, it's defined by effort. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>Overcome your mental roadblock and never give up.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>If you want to be a celebrated loser, be a weight loser. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">Rs2500  <span>(Single class)</span></p>
                                ...
                                <div class="single-features">
                                    ...
                                    <div class="features-caption">
                                        <p>No extra classes</p>
                                    </div>
                                </div>
                                <a href="join.php" class="border-btn border-btn2">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">Rs5000  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">Rs800  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
            ...
            <div class="left-content2">
                ...
                <div class="section-tittle2 mb-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="front-text">
                        ...
                        <p>Hi, my name is Anamol kedem limbu. We are distinguished by our unsurpassed motivating atmosphere, knowledgeable staff and premier exercise equipment, 
                        <p>i've 3 year Gym trainer experience on Gym trainer sector which supports our members in meeting their individual fitness goals.</p>
                        <p>these with dedication to the highest quality of customer satisfaction delivered with a sense of friendliness, individual pride and company spirit.
                        <p class="mb-40">The strength of our heart-felt identity is utilized to inspire every person that steps foot into our gyms to better themselves.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="video-wrap position-relative">
                <div class="video-icon" >
                    <a class="popup-video btn-icon" href="https://www.youtube.com/@ARBVlogsNepal"><i class="fas fa-play"></i></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="" target="_blank">Anamol Gym center</a>
