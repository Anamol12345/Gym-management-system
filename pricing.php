...
<main>
    ...
    require_once './isLogged.php'; 
    if (isLoggedIn()) {
        echo '<a class="border-btn border-btn2" href="join.php" class="btn btn-danger">Join now</a>';
    } else {
        echo '<a href="./user/loginform.php" class="btn btn-primary">Login and join</a>';
    }
    ?>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">Rs8000  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
